...
class TreeTests {
    ...
    private fun <T> renderer(uiGenerator: RowGenerator<T> = rowGenerator()): TreeBehavior<T> {
    ...
    private fun <T> tree(root: TreeNode<T>, ui: TreeBehavior<T> = renderer()) = Tree(SimpleModel(root)).apply { renderer = ui }
