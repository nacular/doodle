...
public open class ButtonModelImpl: ButtonModel {
    override val fired: ChangeObserversImpl<ButtonModelImpl> = ChangeObserversImpl(this)

    override val selectedChanged: PropertyObserversImpl<ButtonModel, Boolean> = PropertyObserversImpl(this)
    override var selected       : Boolean                                     by observable(false, selectedChanged)

    override val armedChanged: PropertyObserversImpl<ButtonModel, Boolean> = PropertyObserversImpl(this)
    override var armed       : Boolean                                     by observable(false, armedChanged)

    override val pressedChanged: PropertyObserversImpl<ButtonModel, Boolean> = PropertyObserversImpl(this)
    ...
    override val pointerOverChanged: PropertyObserversImpl<ButtonModel, Boolean> = PropertyObserversImpl(this)
