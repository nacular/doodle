...
class PopupMenu(strand: Strand, private val display: Display): MutableList<MenuItem, SimpleMutableListModel<MenuItem>>(strand, SimpleMutableListModel(), selectionModel = SingleItemSelectionModel()), MenuItem {
