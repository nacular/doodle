...
class PopupMenu(strand: Strand, private val display: Display): MutableList<MenuItem, MutableListModel<MenuItem>>(strand, MutableListModel(), selectionModel = SingleItemSelectionModel()), MenuItem {
