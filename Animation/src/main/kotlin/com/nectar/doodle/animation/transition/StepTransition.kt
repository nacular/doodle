 ...
 */
class StepTransition(private val delay: Measure<Time>, remaining: Measure<Time>, private val finalValue: Measure<Length>): FixedDurationTransition(delay + remaining) {
    init {
