 ...
 */
class StepTransition(private val delay: Measure<Time>, remaining: Measure<Time>, private val finalValue: Measure<Distance>): FixedDurationTransition(delay + remaining) {
    init {
