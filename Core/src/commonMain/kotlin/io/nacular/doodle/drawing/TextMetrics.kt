...
public interface TextMetrics {
    ...
    public fun size(text: String, width: Double, indent: Double = 0.0, font: Font? = null, lineSpacing: Float = 1f, textSpacing: TextSpacing = default  ): Size = Size(width(text, width, indent, font, textSpacing), height(text, width, indent, font))

    public fun size(text: StyledText, textSpacing: TextSpacing = default                                                                                ): Size = Size(width(text, textSpacing), height(text, textSpacing))
    public fun size(text: StyledText, width: Double, indent: Double = 0.0, lineSpacing: Float = 1f, textSpacing: TextSpacing = default                  ): Size = Size(width(text, width, indent, textSpacing), height(text, width, indent, textSpacing = textSpacing))
}