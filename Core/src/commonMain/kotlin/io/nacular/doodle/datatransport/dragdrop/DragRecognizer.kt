...
public interface DragOperation {
     ...
     */
    public enum class Action { Copy, Move, Link }

    /** The data to be dropped */
    public val bundle: DataBundle

    /** The bundle's visual representation */
    public val visual: Renderable? get() = null

    /** The offset (relative to the pointer) where the [visual] should be rendered */
    public val visualOffset: Point get() = Point.Origin

    /** The set of allowed drop actions */
    public val allowedActions: Set<Action>
     ...
     */
    public fun completed(action: Action)
 ...
 */
public interface DragRecognizer {
    /**
     ...
     */
    public fun dragRecognized(event: PointerEvent): DragOperation?
}
 ...
 */
public inline fun dragRecognized(crossinline handler: (event: PointerEvent) -> DragOperation?): DragRecognizer = object: DragRecognizer {
