...
actual class MutableTreeSet<E> actual constructor(comparator: Comparator<E>, elements: Collection<E>): io.nacular.doodle.utils.TreeSet<E>(comparator, elements), MutableSet<E> {
    actual constructor(comparator: Comparator<E>): this(comparator, emptyList<E>())
