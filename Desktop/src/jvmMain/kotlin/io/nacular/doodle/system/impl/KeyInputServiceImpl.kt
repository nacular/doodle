 ...
 */
internal class KeyInputServiceImpl(private val window: SkiaWindow): KeyInputService, KeyAdapter() {
    ...
    // FIXME: Only notify of UP once
    override fun keyTyped(e: KeyEvent) {
        notifyKeyEvent(e, Up)
    }

    override fun keyPressed(e: KeyEvent) {
        notifyKeyEvent(e, Down)
    }
...
//            VK_SYMBOLLOCK ->
    ...
    private fun startUp() {
        if (!started) {
            window.layer.addKeyListener(this)
    ...
    private fun shutdown() {
        if (started) {
            window.layer.removeKeyListener(this)
