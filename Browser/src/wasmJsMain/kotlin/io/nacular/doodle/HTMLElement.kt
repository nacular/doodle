...
internal actual fun Document.createElement_  (localName: String, options: ElementCreationOptions) = this.createElement(localName, options)
internal actual fun Document.createElementNS_(namespace: String?, qualifiedName: String, options: ElementCreationOptions) = this.createElementNS(namespace, qualifiedName, options)
