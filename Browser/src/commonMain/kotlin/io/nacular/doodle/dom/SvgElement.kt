...
internal inline fun SVGGradientElement.setX1(value: Double) = setAttribute("x1", "$value")
internal inline fun SVGGradientElement.setX2(value: Double) = setAttribute("x2", "$value")
internal inline fun SVGGradientElement.setY1(value: Double) = setAttribute("y1", "$value")
internal inline fun SVGGradientElement.setY2(value: Double) = setAttribute("y2", "$value")
...
internal fun SVGElement.setGradientRotation(value: Measure<Angle>) { setAttribute("gradientTransform", "rotate(${value `in` degrees})") }

internal fun SVGElement.setSpreadMethod (value: String) { setAttribute("spreadMethod",  value) }
internal fun SVGElement.setGradientUnits(value: String) { setAttribute("gradientUnits", value) }
