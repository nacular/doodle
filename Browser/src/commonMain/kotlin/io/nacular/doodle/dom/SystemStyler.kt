    ...
    init {
        ...
        if (!isNested) {
            sheet?.apply {
                ...
                insertRule("${prefix("body")} { -webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale }", numStyles)
